...
const Effects = (() => {
  ...
  function playSound(type) {
    ...
    try {
      ...
      // Add harmonic for richer sound on a separate gain node to avoid
      // clobbering the primary oscillator's exponential ramp-to-zero
      if (type === 'capture' || type === 'check') {
        ...
        osc2.type = 'sine';
        gain2.gain.setValueAtTime(s.vol * 0.5, audioCtx.currentTime);
        gain2.gain.exponentialRampToValueAtTime(0.001, audioCtx.currentTime + s.dur);
